...
SELECT * FROM AMAZON_AND_ECOMMERCE_WEBSITES_PRODUCT_VIEWS_AND_PURCHASES.ONPOINT_ID.POSTAL_CODES LIMIT 100;

SELECT * FROM AMAZON_SALES_AND_MARKET_SHARE_DEMO.ONPOINT_ID.POSTAL_CODES LIMIT 100;

SELECT * FROM CALENDAR_DATA_WITH_DATE_DIMENSIONS__FREE_READY_TO_USE.ONPOINT_ID.POSTAL_CODES LIMIT 100;